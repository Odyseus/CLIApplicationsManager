...
- ``url`` (**Mandatory**): The URL where to download the application.
...
- ``unzip_args`` (**Mandatory**): Arguments passed to the command defined in **unzip_prog**. Key only used by applications of ``type`` **archive**.
